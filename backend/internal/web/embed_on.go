...
func (s *FrontendServer) Middleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if cleanPath == "index.html" || !s.fileExists(cleanPath) {
			s.serveHTML(c, s.baseHTML, s.cache, s.settings.GetGuestPublicSettingsForInjection)
			return
		}
		if cleanPath == "app.html" {
			s.serveHTML(c, s.appHTML, s.appCache, s.settings.GetPublicSettingsForInjection)
			return
		}
...
func (s *FrontendServer) serveHTML(
	c *gin.Context,
	baseHTML []byte,
	cache *HTMLCache,
	loadSettings func(context.Context) (any, error),
) {
