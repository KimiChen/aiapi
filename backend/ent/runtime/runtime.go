...
func init() {
	...
	usagelogDescRequestBytes := usagelogFields[33].Descriptor()
	...
	usagelogDescResponseBytes := usagelogFields[34].Descriptor()
	...
	usagelogDescUpstreamRequestBytes := usagelogFields[35].Descriptor()
	...
	usagelogDescUpstreamResponseBytes := usagelogFields[36].Descriptor()
	...
	usagelogDescTrafficSource := usagelogFields[37].Descriptor()
	...
	usagelogDescTrafficEstimated := usagelogFields[38].Descriptor()
